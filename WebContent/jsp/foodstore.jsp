...
<meta charset="UTF-8">
    ...
    <link href="../css/foodstore.css" rel="Stylesheet"/>
...
<!-- banner部分-->
<div class="store">
    <img src="../images/foodstore/foodstore_top.png" alt=""/>
    <div class="store_top">
        <div class="store_top_left lf">
            <p>必胜客欢乐餐厅 <span>(大钟寺店)</span></p>
            <p><img src="../images/foodstore/foodstore_img1.png" alt=""/>地址：<sapn>海淀区北三环西路大钟寺中坤广场B座商户</sapn>
            <p><img src="../images/foodstore/foodstore_img2.png" alt=""/>营业时间：<span>06:00-14:00  16:00-20:00</span><img src="../images/foodstore/foodstore_img4.png" alt=""/></p>
            <p class="store_collection">
                <img src="../images/foodstore/foodstore_img3.png" alt=""/>收藏店家
            </p>
        </div>
        <div class="store_top_right lf">
            <img src="../images/foodstore/foodstore_img5.png" alt=""/>
            <p>送达时间</p>
            <p>30min<span class="only">起</span></p>
        </div>
        <div class="store_top_right lf">
            <img src="../images/foodstore/foodstore_img6.png" alt=""/>
            <p>起送量</p>
            <p>￥<span>20.00</span></p>
        </div>
        <div class="store_top_right lf">
            <img src="../images/foodstore/foodstore_img7.png" alt=""/>
            <p>配送费</p>
            <p>￥<span>6.00</span></p>
        </div>
        <div></div>
...
<div class="sotre_action">
    <div class="store_action_left">
        <div class="store_action_left_top">
            <p><img src="../images/foodstore/foodstore_icon1.png" alt=""/>精美菜品</p>
            <div>
        ...
        <div class="store_action_left_content">
            <div id="zc">
                ...
                <div class="salc_content">
                    <div id="4">
                        <img src="../images/foodstore/breakfast_img1.png" alt=""/>
                        <div>
                    ...
                    <div id="5">
                        <img src="../images/foodstore/breakfast_img2.png" alt=""/>
                        <div>
                            <p><span class="foodname">精算双人餐</span> <span>￥:<span class="price">20.00</span>/份</span></p>
                            <div>
                                <span class="reduc lf">-</span><input type="text" value="1" class="lf"/><span class="add lf">+</span>
            ...
            <div id="youhui">
                ...
                <div class="salc_content">
                    <div id="1">
                        <img src="../images/foodstore/a-meal_img1.png" alt=""/>
                        <div>
                            <p><span class="foodname">精算双人餐</span> <span>￥:<span class="price">20.00</span>/份</span></p>
                            <div>
                                <span class="reduc lf">-</span><input type="text" value="1" class="lf"/><span class="add lf">+</span>
            ...
            <div id="djzc">
                ...
                <div class="salc_content">
                    <div id="14">
                        <img src="../images/foodstore/lunch_img1.png" alt=""/>
                        <div>
                            <p><span class="foodname">精算双人餐</span> <span>￥:<span class="price">20.00</span>/份</span></p>
                            <div>
                                <span class="reduc lf">-</span><input type="text" value="1" class="lf"/><span class="add lf">+</span>
                    ...
                    <div id="17">
                        <img src="../images/foodstore/lunch_img2.png" alt=""/>
                        <div>
                            <p><span class="foodname">精算双人餐</span> <span>￥:<span class="price">20.00</span>/份</span></p>
                            <div>
                                <span class="reduc lf">-</span><input type="text" value="1" class="lf"/><span class="add lf">+</span>
            ...
            <div id="ylxl">
                ...
                <div class="salc_content">
                    <div id="31">
                        <img src="../images/foodstore/drink_img1.png" alt=""/>
                        <div>
                            <p><span class="foodname">精算双人餐</span> <span>￥:<span class="price">20.00</span>/份</span></p>
                            <div>
                                <span class="reduc lf">-</span><input type="text" value="1" class="lf"/><span class="add lf">+</span>
    ...
    <div class="store_action_right rt">
        <div class="store_action_right_top">
            <p><img src="../images/foodstore/foodstore_icon2.png" alt=""/>商家公告</p>
            <div>
        ...
        <div class="store_action_right_cart">
            ...
            <div class="sarc">
                <div class="total_price lf">
                    <img src="../images/foodstore/foodstore_car_2.png" alt=""/>
                    ￥：<span>0.00</span>
                </div>
                <div class="settle lf">
                    去结算
